...
SRC_URI += "file://no-strip.patch"
LIC_FILES_CHKSUM = "file://COPYRIGHT;md5=a01bb2af662a583c19b563286770ff94"
SRC_URI[md5sum] = "804c6cb5698db30b75ad0ff1c25baefd"
SRC_URI[sha256sum] = "bde845840df4794b869a6efd6a6b1086f80989038e4844b2e4d7d6b57b39c5b6"
...
FILES_${PN} = "${libdir}/lib*.so.* ${sysconfdir}/openldap/ldap.* ${localstatedir}/openldap-data  ${localstatedir}/volatile/*"
