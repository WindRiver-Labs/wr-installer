...
BPN="libuser"
SRC_URI = "https://fedorahosted.org/releases/l/i/${BPN}/${BPN}-${PV}.tar.xz \
...
DEPENDS = "popt libpam glib-2.0 python"
RDEPENDS_${PN} = "libuser"
...
do_install(){
	oe_runmake install-pyexecLTLIBRARIES DESTDIR="${D}"
}
